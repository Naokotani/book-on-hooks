...
func (app *Application) Routes() http.Handler {
	...
	router.HandlerFunc(http.MethodGet, "/api/book/:id", app.bookHandlers.GetBookByIDJSON)
	router.HandlerFunc(http.MethodPatch, "/api/book/:id", app.bookHandlers.UpdateBook)
	router.HandlerFunc(http.MethodDelete, "/api/book/:id", app.bookHandlers.DeleteBook)
	...
	router.HandlerFunc(http.MethodGet, "/api/machine/:id", app.machineHandlers.GetMachine)
	router.HandlerFunc(http.MethodPatch, "/api/machine/:id", app.machineHandlers.UpdateMachine)
	router.HandlerFunc(http.MethodDelete, "/api/machine/:id", app.machineHandlers.DeleteMachine)
	router.HandlerFunc(http.MethodDelete, "/api/machine/:id/books", app.machineHandlers.ClearMachineBooks)
	router.HandlerFunc(http.MethodGet, "/api/machine/:id/books", app.machineHandlers.GetMachineWithBooks)
